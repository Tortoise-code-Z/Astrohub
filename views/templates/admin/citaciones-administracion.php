...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/pages/admin/citaciones-admin.css">
    <title>Astrohub-Administracion-citas</title>
</head>
...
<body>
    ...
    <main>
        <h1 class="txt-primary-color">Administración de citas</h1>
        <section class="a-section">
            ...
            <div class="container">
                ...
                <div class="inp-filter-container">
                    ...
                    <a href="./index.php?controller=adminCreateCita" class="btn btn-primary create">
                ...
                <div class="users-container users-show">
                    ...
                    <?php foreach ($users as $value): ?>
                        ...
                        <!-- item -->
                        <a class="user-item" id="<?php echo $value['idUser'] ?>" href="#appointments-results">
        ...
        <section class="a-appointmenstResult" id="appointments-results">
            <div class="container">
                <h2 class="txt-primary-color">Citas usuario</h2>
                <div class="user-selected">
                    <h3 class="us-name">Ningún usuario seleccionado...</h3>
                </div>
                <div class="appointments-user-container"></div>
        </section>
    </main>
    ...
    <script type="module" src="./assets/js/pages/admin/citaciones-admin.js"></script>
</body>
