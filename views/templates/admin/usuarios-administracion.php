...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/pages/admin/user-admin.css">
    <title>Astrohub-admin-usuarios</title>
</head>
...
<body>
    ...
    <main>
        <h1 class="txt-primary-color">Administración de Usuarios</h1>
        <section class="a-section">
            ...
            <div class="container">
                ...
                <div class="inp-filter-container">
                    ...
                    <a href="./index.php?controller=adminCreateUser" class="btn btn-primary create">
                ...
                <div class="users-container users-show">

                    <!-- Mostrar todos los usuarios -->
                    <?php foreach ($users as $value): ?>

                        <!-- item -->
                        <div class="user-item" id="<?php echo $value['idUser'] ?>">
                            <div class="user-data">
                            ...
                            <div class="user-buttons">
                                <a href="./index.php?controller=adminEditUser&id=<?php echo $value['idUser'] ?>" class="btn btn-primary">Editar</a>
                                <a href="./index.php?controller=deleteUser&id=<?php echo $value['idUser'] ?>" class="btn btn-trash user-delete">Borrar</a>
                            </div>
                        </div>
    ...
    <script type="module" src="./assets/js/pages/admin/users-admin.js"></script>
</body>
